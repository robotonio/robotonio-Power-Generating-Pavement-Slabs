...
Το πρότυπό μας είναι προγραμματισμένο με την γλώσσα Python, στην εφαρμογή της Microsoft MicroBit Μakecode. Η λειτουργία του είναι απλή και παρουσιάζεται στο ακόλουθο διάγραμμα:
